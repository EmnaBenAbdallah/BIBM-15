...
% Finally the \texttt{selectProc(A,I)} permits to define the fixed point which is compound by these selected processes:
% \begin{lstlisting}
% fixProc(A,I) :- selectProc(A,I). %\label{fixproc}
% \end{lstlisting}
