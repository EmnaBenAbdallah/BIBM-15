...
However, the iterative version of \textsc{Clingo} will continue to iterate even no answer is satisfied by the itirative part of the program. We faced this problem in the solver of \textsc{Clingo}, indeed the it should return an \texttt{unsatisfiable} response instead of iterating in vacuum.
