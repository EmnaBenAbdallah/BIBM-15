...
Our recently introduced formalism, the Process Hitting (PH), defined as a restriction of synchronous automata networks is notably suitable to such study. Furthermore, it is not limited to model and analyze BRNs.
